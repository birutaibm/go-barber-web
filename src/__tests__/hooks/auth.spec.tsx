...
describe('Auth hook', () => {
  it('should be able to sign in', async () => {
    ...
    expect(setItemSpy).toBeCalledWith('@GoBarber:user', JSON.stringify(apiResponse.user));
    expect(api.defaults.headers.authorization).toEqual(`Bearer ${apiResponse.token}`);
